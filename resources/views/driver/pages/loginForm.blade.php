                ...
                <div class="row wrap-login100">
                    <div class="col-md-6 col-sm-12">
                        <form class="login100-form validate-form" action="{{ route('employee.do.login') }}" method="post">
                            ...
                            <div class="form-group" value="{{ old('email') }}" data-validate="Valid email is required: ex@abc.xyz">
                                <label for="email">Email</label>
                                <input class="form-control py-3" type="text" name="email" placeholder="email" />
                            ...
                            <div class="form-group" data-validate="Password is required">
                                ...
                                <input class="form-control py-3" type="password" name="password" placeholder="password"/>
                                <span class="focus-input100"></span>
                                @error('password')
                                <span class="text-danger mb-2">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="flex-sb-m w-full p-t-3 p-b-32">
                                <div>
                                    <a href="{{ route('employye.forget.password') }}" class="txt1">
                                        Forgot Password?
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12 login100-more" style="background-image: url('{{ asset('driver/auth/images/img_02.jpg') }}');"></div>
                </div>
            </div>
        </div>
