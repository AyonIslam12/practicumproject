...
<head>
    ...
    <title>Ayon'Car-Rental-House</title>
	<!-- core CSS -->
    <link href="{{ asset('fontend_assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/owl.carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/owl.transitions.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/prettyPhoto.css') }}" rel="stylesheet">
	<link href="{{ asset('fontend_assets/css/magnific-popup.css') }}" rel="stylesheet">
	<link href="{{ asset('fontend_assets/css/gallery-1.css') }}" rel="stylesheet">
    <link href="{{ asset('fontend_assets/css/styles.css') }}" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="js/html5shiv.js"></script>
    <script src="js/respond.min.js"></script>
    <![endif]-->
    <link rel="shortcut icon" href="{{ asset('fontend_assets/images/ico/favicon.ico') }}">
</head>
...
<body id="home">
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image:  url({{ ('/fontend_assets/images/slider/bg1.jpg') }}); ">
             ...
             <div class="item" style="background-image: url({{ ('/fontend_assets/images/slider/bg2.jpg') }}); ">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
							<div class="carousel-caption">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                  <img class="img-responsive" src="{{ asset('/fontend_assets/images/about.png')}}" alt="">
                </div>
            ...
            <div class="row">
                <div id="isotope-gallery-container">
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper artwork creative">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/1.jpg')}}" class="img-responsive" alt="1st gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/1.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature outside">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/2.jpg')}}" class="img-responsive" alt="2nd gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/2.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                                <a href="#" class="gallery-link"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="gallery-details">
                            	<div class="editContent">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper photography artwork">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/3.jpg')}}" class="img-responsive" alt="3rd gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/3.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                                <a href="#" class="gallery-link"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="gallery-details">
                            	<div class="editContent">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper creative nature">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/4.jpg')}}" class="img-responsive" alt="4th gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/4.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                                <a href="#" class="gallery-link"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="gallery-details">
                            	<div class="editContent">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/5.jpg')}}" class="img-responsive" alt="5th gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/5.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                                <a href="#" class="gallery-link"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="gallery-details">
                            	<div class="editContent">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper artwork creative">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{asset('fontend_assets/images/portfolio/6.jpg')}}" class="img-responsive" alt="6th gallery Thumb">
                                <div class="image-overlay"></div>
                                <a href="{{asset('fontend_assets/images/portfolio/6.jpg')}}" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                                <a href="#" class="gallery-link"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="gallery-details">
                            	<div class="editContent">
...
<div id="google-map" style="height:400px" data-latitude="40.7141667" data-longitude="-74.00638891"></div>
    ...
    <script src="{{ asset('fontend_assets/js/jquery.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/bootstrap.min.js')}}"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="{{ asset('fontend_assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/mousescroll.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('fontend_assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('fontend_assets/contact/jqBootstrapValidation.js') }}"></script>
    <script src="{{ asset('fontend_assets/contact/contact_me.js') }}"></script>

    <script type="text/javascript" src="{{ asset('fontend_assets/js/jquery.isotope.min.js') }}"></script><!-- Gallery Filter -->
	<script type="text/javascript" src="{{ asset('fontend_assets/js/jquery.magnific-popup.min.js') }}"></script><!-- Gallery Popup -->

    <script src="{{ asset('fontend_assets/js/custom-scripts.js') }}"></script>
</body>
</html>
