              ...
              <div class="panel-body mt-5"  >
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form"  class="form" action="{{ route('website.forget.password.link') }}" method="post">
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <a  href="{{ route('website.user.login.form') }}" class="btn btn-lg btn-secondary btn-block">Back</a>
                      </div>
